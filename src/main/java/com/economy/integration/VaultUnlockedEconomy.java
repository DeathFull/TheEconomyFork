...
public class VaultUnlockedEconomy implements Economy {
    ...
    public EconomyResponse withdraw(String playerName, UUID playerUuid, String world, String currency, BigDecimal amount) {
        return withdraw(playerUuid, world, amount);
    }
    ...
    public EconomyResponse createPlayerAccount(String playerName) {
        ...
        return new EconomyResponse(BigDecimal.ZERO, BigDecimal.valueOf(initialBalance), EconomyResponse.ResponseType.SUCCESS, 
            "Account created");
    }
