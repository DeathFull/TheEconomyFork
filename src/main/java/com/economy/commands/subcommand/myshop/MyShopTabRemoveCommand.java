...
public class MyShopTabRemoveCommand extends AbstractAsyncCommand {

    private RequiredArg<String> tabName;

    public MyShopTabRemoveCommand() {
        super("remove", com.economy.util.LanguageManager.getTranslation("desc_myshop_tab_remove"));
    ...
    protected CompletableFuture<Void> executeAsync(CommandContext commandContext) {
        ...
        if (ref != null && ref.isValid()) {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                boolean removed = PlayerShopManager.getInstance().removeTab(playerUuid, tabNameValue);
