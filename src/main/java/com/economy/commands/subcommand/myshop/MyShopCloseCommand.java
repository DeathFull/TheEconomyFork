...
public class MyShopCloseCommand extends AbstractAsyncCommand {

    public MyShopCloseCommand() {
        super("close", com.economy.util.LanguageManager.getTranslation("desc_myshop_close"));
    ...
    protected CompletableFuture<Void> executeAsync(CommandContext commandContext) {
        ...
        return CompletableFuture.runAsync(() -> {
            world.execute(() -> {
                ...
                shopManager.setShopOpen(playerUuid, false);
                player.sendMessage(LanguageManager.getMessage("chat_myshop_closed", Color.YELLOW));
            });
        }, world);
    }
}
